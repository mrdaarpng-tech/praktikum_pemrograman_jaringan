...
$contracts = [
  ...
  [
    'Endpoint' => '/api/v1/users',
    'Method' => 'POST',
    'ParamsBody' => '{ "name":"Dabitio Mantong", "email":"tio@gmail.com", "password":"223611205", "role":"user" }',
    'Response' => '{ "success":true, "message":"User berhasil ditambahkan" }'
  ],
  [
    'Endpoint' => '/api/v1/users/{id}',
    'Method' => 'PUT',
    'ParamsBody' => '{ "name":"Mirda Rupang", "email":"Mrdaarpng@gmail.com", "role":"admin" }',
...
<body>
  ...
  <p>Versi API: v1.0.0 | Dibuat oleh <strong>Mirda Rupang </strong> di Praktikum Pemrograman Jaringan © <?= date('Y') ?></p>
</body>
</html>
